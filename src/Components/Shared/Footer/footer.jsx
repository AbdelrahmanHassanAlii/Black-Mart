...
return (
    ...
    <div className="flex flex-col md:flex-row gap-8 mt-8 w-full">
        <div className="flex flex-col w-full md:w-1/3 gap-4">
            ...
            <div className="flex gap-3">
                ...
                <div className="bg-white text-black w-10 h-10 flex items-center justify-center border cursor-pointer hover:-translate-y-1 border-slate-900 rounded-full transition-transform">
                   <a href="https://github.com/AbdelrahmanHassanAlii/Black-Mart.git"> <FaGithub /></a>
                </div>
</div> 
        </div>
    ...
    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
        <p className="opacity-75 text-center sm:text-left">Shop.co © 2000-2023, All Rights Reserved</p>
        <div className="flex flex-wrap justify-center gap-4">
        <img src="/logos/visa.png" alt="" className="w-10 cursor-pointer hover:-translate-y-0.5 transition-transform" />
          <img src="/logos/card.png" alt="" className="w-10 cursor-pointer hover:-translate-y-0.5 transition-transform" />
          <img src="/logos/paypal.png" alt="" className="w-10 cursor-pointer hover:-translate-y-0.5 transition-transform" />
          <img src="/logos/apple-pay.png" alt="" className="w-10 cursor-pointer hover:-translate-y-0.5 transition-transform" />
          <img src="/logos/google-pay.png" alt="" className="w-10 cursor-pointer hover:-translate-y-0.5 transition-transform" />
        </div>
    </div>
    </div>
);
